...
class Heap {
    ...
    public void construir(int tamHeap) {
       for (int i = tamHeap; i > 1 && filme[i].getGenero().compareTo(filme[i / 2].getGenero()) > filme[i / 2].getGenero().compareTo(filme[i].getGenero()); i /= 2) {
           swap(i, i / 2);
       }
    }
    ...
    public void reconstruir(int tamHeap) {
        ...
        while (i <= (tamHeap / 2)) {
            ...
            if (filme[i].getGenero().compareTo(filme[filho].getGenero()) < filme[filho].getGenero().compareTo(filme[i].getGenero())) {
                swap(i, filho);
                i = filho;
                cont++;
            } else {
    ...
    public int getMaiorFilho(int i, int tamHeap) {
        ...
        if (2 * 1 == tamHeap || filme[2 * i].getGenero().compareTo(filme[2 * i + 1].getGenero()) > filme[2 * i + 1].getGenero().compareTo(filme[2 * i].getGenero())) {
            filho = 2 * i;
            cont++;
        } else {
            filho = 2 * i + 1;
    ...
    public void insercaoSort() {
        ...
        for (int i = 1; i < n; i++) {
            ...
            while ((j >= 0) && ((filme[j].getGenero().compareTo(tmp.getGenero())) > (tmp.getGenero().compareTo(filme[j].getGenero())))) {
                filme[j + 1] = filme[j];
                j--;
                cont++;
            }
...
public class Heapsort {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Heap movie = new Heap(10000); // criar uma lista da classe List
        ...
        Arq.openWrite("748190_heapsort.txt");
