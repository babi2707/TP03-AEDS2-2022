 ...
 * Matricula: 748190
 * TP03 - Questão 1 - Ordenação por Seleção em Java
 * 
****************************************/
...
class Selection {
    ...
    public void sort() {
        for (int i = 0; i < (n-1); i++) {
            ...
            for (int j = (i+1); j < n; j++) {
                if ((filme[menor].getTitulo_Original().compareTo(filme[j].getTitulo_Original())) > filme[j].getTitulo_Original().compareTo(filme[menor].getTitulo_Original())){
                    menor = j;
                    cont++;
                }
            }
...
public class Selecao {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Selection movie = new Selection(10000); // criar uma lista da classe List
        ...
        Arq.openWrite("748190_selecao.txt");
