 ...
 * Matricula: 748190
 * TP03 - Questão 8 - Ordenação por Bubble sort em Java
 * 
****************************************/
...
class Bolha {
    ...
    public void sort() {
        for (int i = (n-1); i > 0 ; i--) {
            for (int j = 0; j < i; j++) {
                if ((filme[j].getDuracao() > filme[j + 1].getDuracao())) {
                    swap(j, j+1);
                    cont++;
                }
            }
...
public class Bubble {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Bolha movie = new Bolha(10000); // criar uma lista da classe List
        ...
        Arq.openWrite("748190_bolha.txt");
